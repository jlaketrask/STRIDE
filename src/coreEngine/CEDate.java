...
public class CEDate implements Serializable {
     ...
     * type in the given portion of a month.  For example, numDayInMonth[0] = 4 indicates that
     * there are 4 Mondays in the specified portion of the month.  Note: whether or not a day
     * is active in the study period is not considered.
     * @param year
     * @param month
     * @param startDay
     * @param endDay
