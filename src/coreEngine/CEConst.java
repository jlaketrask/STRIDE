...
public class CEConst {
    ...
    /**
     * Facility Wide - Average vehicle occupancy in general purpose lanes (passenger / vehicle)
     */
    public final static String IDS_OCCU_GP = "IDS_OCCU_GP";
    
    /**
     * Facility Wide - Average vehicle occupancy in managed lanes (passenger / vehicle)
     */
     ...
     * Seed/User CAF
     */
    public final static String IDS_U_CAF = "IDS_UCAF";

    /**
     * Seed/User OAF
     */
    public final static String IDS_U_OAF = "IDS_UOAF";

    /**
     * Seed/User DAF
     */
    public final static String IDS_U_DAF = "IDS_UDAF";

    /**
     * Seed/User SAF
     */
    public final static String IDS_U_SAF = "IDS_USAF";

    /**
     * Reliability Analysis Scenario CAF
     */
    public final static String IDS_RL_CAF = "IDS_RLSCAF";

    /**
     * Reliability Analysis Scenario OAF
     */
    public final static String IDS_RL_OAF = "IDS_RLSOAF";

    /**
     * Reliability Analysis Scenario DAF
     */
    public final static String IDS_RL_DAF = "IDS_RLSDAF";

    /**
     * Reliability Analysis Scenario SAF
     */
    public final static String IDS_RL_SAF = "IDS_RLSSAF";

    /**
     * Reliability Analysis Scenario LAF
     */
    public final static String IDS_RL_LAFI = "IDS_RLSLAFI";
    
    /**
     * Reliability Analysis Scenario LAF
     */
    public final static String IDS_RL_LAFWZ = "IDS_RLSLAFWZ";
