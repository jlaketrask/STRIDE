...
public abstract class ScenarioEvent implements Serializable {
     ...
     * @param scenarioIdx Scenario the event is associated with
     * @param severity Severity of the event
     * @param startPeriod Period in which the event starts.
     * @param duration Duration (in periods) of the event.
     */
    public ScenarioEvent(Seed seed, int scenarioIdx, int severity, int startPeriod, int duration) {
        this.seed = seed;
