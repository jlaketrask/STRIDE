...
//        }
    ...
    public void MMHeuristic() {
        ...
        while (theta > 0.0f) {
            ...
            if (delta > 0) {
                for (int i = 0; i < pi.length; i++) {
                    ...
                    candDelta = dotProduct(pi, atdmTTI) - populationMoments[0];
        ...
        MainWindow.printLog("1st moment: " + populationMoments[0] + " " + dotProduct(pi, atdmTTI));
        MainWindow.printLog("2nd moment: " + populationMoments[1] + " " + dotProduct(pi, vectorPower(atdmTTI, 2)));
        
        float convergePctMean = Math.abs(populationMoments[0] - dotProduct(pi, atdmTTI))/populationMoments[0];
        float convergePctVar = Math.abs(populationMoments[1] - dotProduct(pi, vectorPower(atdmTTI, 2)))/populationMoments[1];
        ...
        if (convergePctMean > 0.15) {
            String messageString = "<HTML><CENTER>WARNING<br>&nbsp<br>Could not converge to within 15&#37 of the population mean.<br>&nbsp<br>"
                    ...
                    + "Population mean: "+populationMoments[0]+"&nbsp&nbsp&nbsp&nbsp&nbsp Mapped After Set mean: "+dotProduct(pi, atdmTTI)+"&nbsp&nbsp&nbsp&nbsp&nbsp&#37 Diff: "+convergePctMean+"<br>"
                    + "Population variance: "+populationMoments[1]+"&nbsp&nbsp&nbsp&nbsp&nbsp Mapped After Set variance: "+dotProduct(pi, vectorPower(atdmTTI, 2))+"&nbsp&nbsp&nbsp&nbsp&nbsp&#37 Diff: "+convergePctVar+"<br>";
