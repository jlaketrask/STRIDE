...
public class SeedFillDataDialog extends javax.swing.JDialog {
    ...
    private final static String STR_LENGTH_OF_WEAVING = "Weave Segment Ls";
    ...
    // Weaving Segment Variable Column Text
    private final static String STR_ML_LENGTH_OF_WEAVING = "ML Weave Segment Ls";
    ...
    private void setupComboBox() {
        ...
        itemSettingsGP = new ItemSetting[]{
            ...
            new ItemSetting(STR_RV_CAR_EV, periodModel_fix, segmentModel_all_GP),
            ...
            new ItemSetting(STR_TRUCK_PERCENTAGE, periodModel_var, segmentModel_all_GP),
            new ItemSetting(STR_RV_PERCENTAGE, periodModel_var, segmentModel_all_GP),
            new ItemSetting(STR_CAF, periodModel_var, segmentModel_all_GP),
            new ItemSetting(STR_OAF, periodModel_var, segmentModel_all_GP),
            new ItemSetting(STR_DAF, periodModel_var, segmentModel_all_GP),
            new ItemSetting(STR_FFSAF, periodModel_var, segmentModel_all_GP),
            // On Ramp Variable Column Text
            new ItemSetting(STR_ACC_DEC_LANE_LENGTH, periodModel_fix, segmentModel_ONR_OFR_GP),
            new ItemSetting(STR_NUM_ON_RAMP_LANES, periodModel_var, segmentModel_ONR_W_GP),
            ...
            // Off Ramp Variable Column Text
            new ItemSetting(STR_NUM_OFF_RAMP_LANES, periodModel_var, segmentModel_OFR_W_GP),
        ...
        itemSettingsML = new ItemSetting[]{
            new ItemSetting(STR_ML_TYPE, periodModel_fix, segmentModel_all_ML),
            ...
            new ItemSetting(STR_ML_TRUCK_PERCENTAGE, periodModel_var, segmentModel_all_ML),
            new ItemSetting(STR_ML_RV_PERCENTAGE, periodModel_var, segmentModel_all_ML),
            ...
            new ItemSetting(STR_ML_NUM_ON_RAMP_LANES, periodModel_var, segmentModel_ONR_W_ML),
            ...
            // Off Ramp Variable Column Text
            new ItemSetting(STR_ML_NUM_OFF_RAMP_LANES, periodModel_var, segmentModel_OFR_W_ML),
            ...
            new ItemSetting(STR_ML_HAS_CW, periodModel_fix, segmentModel_all_ML),
            new ItemSetting(STR_ML_CW_LC_MIN, periodModel_fix, segmentModel_all_ML),
            new ItemSetting(STR_ML_CW_VOLUME, periodModel_var, segmentModel_all_ML)
        };
    ...
    private void fillDataHelper(int segIndex, int periodIndex) {
        switch (itemCB.getSelectedItem().toString()) {
            ...
            case STR_RV_CAR_EV:
                seed.setValue(CEConst.IDS_RV_CAR_ER, Float.parseFloat(valueText.getText()), segIndex);
                break;
            ...
            case STR_TRUCK_PERCENTAGE:
                seed.setValue(CEConst.IDS_TRUCK_PERCENTAGE, Float.parseFloat(valueText.getText()), segIndex, periodIndex);
                break;

            case STR_RV_PERCENTAGE:
                seed.setValue(CEConst.IDS_RV_PERCENTAGE, Float.parseFloat(valueText.getText()), segIndex, periodIndex);
                break;

            case STR_CAF:
                seed.setValue(CEConst.IDS_U_CAF, Float.parseFloat(valueText.getText()), segIndex, periodIndex);
                break;

            case STR_OAF:
                seed.setValue(CEConst.IDS_U_OAF, Float.parseFloat(valueText.getText()), segIndex, periodIndex);
                break;

            case STR_DAF:
                seed.setValue(CEConst.IDS_U_DAF, Float.parseFloat(valueText.getText()), segIndex, periodIndex);
                break;

            case STR_FFSAF:
                seed.setValue(CEConst.IDS_U_SAF, Float.parseFloat(valueText.getText()), segIndex, periodIndex);
                break;
            ...
            case STR_ML_TRUCK_PERCENTAGE:
                seed.setValue(CEConst.IDS_ML_TRUCK_PERCENTAGE, Integer.parseInt(valueText.getText()), segIndex, periodIndex);
                break;

            case STR_ML_RV_PERCENTAGE:
                seed.setValue(CEConst.IDS_ML_RV_PERCENTAGE, Integer.parseInt(valueText.getText()), segIndex, periodIndex);
                break;
