...
public class ConfigIO {
     ...
     */
    public static String saveSeedListToConfig(ArrayList<Seed> seedList) {
        try {
    ...
    public static String saveGraphicConfig(ArrayList<GraphicColorSetting> colorSettings) {
        ...
        //MainWindow.printLog(location);
        //ClassLoader.getSystemClassLoader().getResource(".").getPath();
        //MainWindow.printLog(ConfigIO.class.getProtectionDomain().getCodeSource().getLocation().getPath());
        //MainWindow.printLog(ConfigIO.class.getProtectionDomain().getCodeSource().getLocation().toURI().g‌​etPath());
    }
    ...
    private static String getCfgFolderLocation() {
