...
public class SegIOTableWithSetting implements FREEVAL_TableWithSetting {
    ...
    private void _resetCellSettings() {
        ...
        STR_LENGTH_OF_WEAVING = "Weave Segment Ls";
        ...
        //settings.add(new CellSetting(STR_PEAK_HR_FACTOR, CEConst.IDS_PEAK_HR_FACTOR, false, false, COLOR_FIX_INPUT, true, false, true));
        //settings.add(new CellSetting(STR_DRIVER_POP_FACTOR, CEConst.IDS_DRIVER_POP_FACTOR, false, false, COLOR_FIX_INPUT, true, false, true));
        //basic time depended input data
        //new CellSetting(STR_TIME_DEPENDENT_DATA, CEConst.IDS_TIME_DEPENDENT_DATA, true, false, true, false, true));
        ...
        settings.add(new TableCellSetting(STR_U_CAF, CEConst.IDS_U_CAF, true, false, COLOR_GP_TIME_INPUT, true, false, true));
        settings.add(new TableCellSetting(STR_U_OAF, CEConst.IDS_U_OAF, true, false, COLOR_GP_TIME_INPUT, true, false, true));
        settings.add(new TableCellSetting(STR_U_DAF, CEConst.IDS_U_DAF, true, false, COLOR_GP_TIME_INPUT, true, false, true));
        settings.add(new TableCellSetting(STR_U_SAF, CEConst.IDS_U_SAF, true, false, COLOR_GP_TIME_INPUT, true, false, true));
        settings.add(new TableCellSetting(STR_RL_OAF, CEConst.IDS_RL_OAF, true, false, COLOR_GP_SCENARIO_1, true, false, true));
        settings.add(new TableCellSetting(STR_RL_DAF, CEConst.IDS_RL_DAF, true, false, COLOR_GP_SCENARIO_1, true, false, true));
        settings.add(new TableCellSetting(STR_RL_CAF, CEConst.IDS_RL_CAF, true, false, COLOR_GP_SCENARIO_2, true, false, true));
        settings.add(new TableCellSetting(STR_RL_SAF, CEConst.IDS_RL_SAF, true, false, COLOR_GP_SCENARIO_2, true, false, true));
        settings.add(new TableCellSetting(STR_RL_LAFI, CEConst.IDS_RL_LAFI, true, false, COLOR_GP_SCENARIO_2, true, false, true));
        settings.add(new TableCellSetting(STR_RL_LAFWZ, CEConst.IDS_RL_LAFWZ, true, false, COLOR_GP_SCENARIO_2, true, false, true));
...
//        settings.add(new CellSetting(STR_ML_SOAF, CEConst.IDS_ML_RLSOAF, true, false, COLOR_ML_SCENARIO_1, false, true, true));
//        settings.add(new CellSetting(STR_ML_SDAF, CEConst.IDS_ML_RLSDAF, true, false, COLOR_ML_SCENARIO_1, false, true, true));
//        settings.add(new CellSetting(STR_ML_SCAF, CEConst.IDS_ML_RLSCAF, true, false, COLOR_ML_SCENARIO_2, false, true, true));
//        settings.add(new CellSetting(STR_ML_SSAF, CEConst.IDS_ML_RLSSAF, true, false, COLOR_ML_SCENARIO_2, false, true, true));
//        settings.add(new CellSetting(STR_ML_SLAF, CEConst.IDS_ML_RLSLAF, true, false, COLOR_ML_SCENARIO_2, false, true, true));
...
//    transient private String STR_ML_SLAF;
    ...
    private static final Color COLOR_GP_FIX_INPUT = Color.green; //new Color(0, 255, 0)
    private static final Color COLOR_GP_TIME_INPUT = Color.yellow; //new Color(255, 255, 0)
