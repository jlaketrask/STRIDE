...
public class ATDMDatabase implements Serializable {
    ...
    private void initDemandDefaultStrategies() {
        int startId = 1;
        if (demandStrat.size() >= 0) {
            startId = demandStrat.size();
        }
    ...
    private void initWeatherDefaultStrategies() {
        int startId = 1;
        if (weatherStrat.size() >= 0) {
            startId = weatherStrat.size();
        }
    ...
    private void initIncidentDefaultStrategies() {
        int startId = 1;
        if (incidentStrat.size() >= 0) {
            startId = incidentStrat.size();
        }
    ...
    private void initWorkZoneDefaultStrategies() {
        int startId = 1;
        if (workZoneStrat.size() >= 0) {
            startId = workZoneStrat.size();
        }
